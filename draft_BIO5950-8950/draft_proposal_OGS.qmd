...
-   **Hypothesis 1**: Punctual extreme weather events have acted as selection bottlenecks, favoring heavier individuals in the population.
    ...
    -   **Methodology 1**: I will analyze extreme weather events at the study sites and investigate their relationship with population fluctuations and the genetic values of mean body mass across the study period.

-   **Hypothesis 2**: Drought events, which have become more frequent with global warming, increase the proportion of dry vegetation, selecting for larger individuals that can consume a more fibrous diet due to longer Mean Retention Time (MRT) [@armitage2014].

    -   **Methodology 2**: I will study the marmots' diet composition over the years to evaluate changes in vegetation quality and selection.

-   **Hypothesis 3**: Larger individuals will be favored by natural selection because they are better able to fend off smaller predators such as *Mustela frenata* and *Martes americana* [@armitage2014].

    -   **Methodology 3**: I will examine predator population dynamics and species composition and compare that to the recorded causes of marmot mortality over the study period.
