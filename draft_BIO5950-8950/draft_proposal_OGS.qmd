...
-   **Hypothesis 5**: A shift in body condition will result in behavioral changes at the individual level.
    ...
    -   **Methodology 5**: I will assess changes in individual behavior by analysis boldness data collected through Flight Initiation Distance (FID) experiments over the sutdy period.
