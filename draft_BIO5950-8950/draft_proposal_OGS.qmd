...
-   **Hypothesis 2**: Drought events, which have become more frequent with global warming, increase the proportion of dry vegetation, enhancing selection for larger individuals that can consume a more fibrous diet due to longer Mean Retention Time (MRT) [@armitage2014].
...
-   **Hypothesis 3**: Larger individuals will be favored by natural selection as they are better able to fend off smaller predators such as *Mustela frenata* and *Martes americana* [@armitage2014].
...
-   **Hypothesis 5**: A shift in body condition will result in behavioral changes at the individual level.
    ...
    -   **Methodology 5**: I will assess changes in individual behavior by analysis of boldness data collected through Flight Initiation Distance (FID) experiments over the study period and test its link with body mass.
