...
Body mass plays a critical role for most species. It affects indidivual metabolic rate [@darveauAllometricCascadeUnifying2002] as well as performance (e.g., foraging, exploration, fighting, competition ability). For instance, @weibelAllometricScalingMaximal2004 showed a strong correlation between maximal metabolic rate and body mass in mammals.

Body mass also determines individuals energetic reserves, thereby impacting performance<!-- REF --> and resilience to environmental challenges by buffering against seasonal food scarcity [@heldstabHowMammalsBuffer2017]. More generaly, body fat can be considered a buffer against harsh environments [@denryterSurvivalFattestHow2022]. Extending this reasoning to a wider timescale, we can expect that larger individuals may better buffer rseource-poor years, increasing their resilience to environmental variability and unpredictability [@einum2004environmental].
...
<!-- TODO: add something about the impact of body mass on competitive ability -->
