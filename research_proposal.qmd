...
To study such changes, we rely on Life-History Theory. This framework is used to study how resources are allocated to specific traits to cope with environment while maximizing individual fitness. The theory rely on the fact that resources are limited and trade-off must be made between different traits to achieve the best life-history strategy [@Roff1992TheEO; @10.1093/oso/9780198577416.001.0001; @bellCostsReproductionTheir1980]
...
When an environment changes, inhabiting populations will have several solutions to avoid disappearance. They can disperse to another, more favourable, environment [@gienappEvolutionaryDynamicsResponse2014]; they can modify their environment to correspond to specific needs (**REF**); or phenotypic changes can occur in the population, giving individuals better suited to their environment [@gienappEvolutionaryDynamicsResponse2014].
...
Parental links between individuals are known for most individuals in the population (4,652 individuals to this date), allowing the reconstruction of a highly detailed pedigree. Before 2002, maternal links were estimated via behavioural observations. Since 2002, genetic parentage assignment is used to confirm the maternal links and determine the paternal links [details in @blumsteinHeritabilityAntipredatoryTraits2010; @olsonNoEvidenceInbreeding2012].
...
5. From Mass to Manner: How Body Mass and Age Shape Behaviour in Yellow-Bellied Marmots. [A Birot, D Blumstein and JGA Martin]{.underline}. Targeted journal: *Proc. R. Soc. B.*; *Oikos*
