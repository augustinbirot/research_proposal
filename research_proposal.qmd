...
To properly estimate the evolutionary signals of a phenotypic change, quantitative genetic gives us a method to decompose the total phenotypic variance ($V_P$) into it's genetic ($V_A$) and environmental ($V_{PE}$) part: $V_P = V_A + V_{PE}$ [@lynchGeneticsAnalysisQuantitative1998; @wilsonEcologistsGuideAnimal2010]. <!-- Rephrase that, recheck the proper term -->
