...
2. Towards more comprehensive studies of phenotypic changes: Adressing the missing fraction problem in Yellow-bellied Marmots' body mass. [A Birot, 
  D Blumstein and JGA Martin]{.underline}. Targeted journal:
...
4. Which part of climate change drives body mass evolution? [A Birot, D Blumstein and 
  JGA Martin]{.underline}. Targeted journal:


5. Balance between body condition and experience as predictor of marmots' behavior.^[JM is it really what you will be looking at in chapter 4, I don't think so] [A Birot, D Blumstein and JGA Martin]{.underline}. Targeted journal:
...
7. Identify key patches for metapopulation persistence using Social Network Analysis methods.
  ...
  (JGA Martin), Y Araya-Ajoy]{.underline}. Targeted journal:
