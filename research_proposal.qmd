...
Therefore, we expect natural population to **evolve**, allowing them to be better suited to new environmental conditions [@darwinOriginSpeciesMeans1859].
...
But, by definition, a "bet" comports risks, and in such variable conditions due to an extremely fast climate change, betting on the future can end in maladaption and cause local disparition.
