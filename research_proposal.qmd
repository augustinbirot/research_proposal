...
According to the extended Pace Of Life Syndrome [POLS, @dammhahnPacelifeSyndromesFramework2018; @realePersonalityEmergencePaceoflife2010], we expect to see a clear effect of the body mass on the behavior. However, by looking at some preliminary results, although some results seems statistically significant, the biological effect is fairly small


proportion of time stand looking highly body mass dependant especially during the two first years of life, but the impact of body mass is less and less important with age, to become almost flat in adults [@fig-prop-slook]. Athough the impact of body mass, with heavier individuals spending more time looking is easily explanable as heavier individuals are slower and thus must stay more vigilent to avoid predation, this age effect is interesting to note and advocate for the hypothesis that with age, experience prevail on physical condition to dictate behavior, with older individuals more careful than juveniles, as already suggested by @jebbBiggerNotAlways2021.
