...
These phenotypic changes could happen in two ways: phenotypic plasticity, define as the capacity of one genotype to express different phenotype depending on the environment, allowing for rapid responses within an individual's lifetime, is highly flexible and does not involve any changes at the genetic level [@pigliucciPhenotypicPlasticityNature2001]; and evolution, define as a change in alleles frequencies in a population over time.<!-- Evolution can happen through natural selection:--> When an individual with a better-fitted phenotype for its new environment appears, it would have a higher survival and reproductive success. If this advantage relies on a heritable genetic difference, the new genotype is going to rapidly increase in proportion in the population, ultimately replacing the old one [@lynchGeneticsAnalysisQuantitative1998]. <!-- Or through genetic drift: In a finite population, when a new mutation appears, it can spread in the next generations -->
