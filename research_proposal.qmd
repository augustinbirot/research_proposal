...
Life-history theory studies ressources allocation between the life-history traits of an individual. This theory considers that individuals in natural condition have limited time and ressources and therefore must trade-off their allocations between competing functions such as growth, maintenance and reproduction [@Roff1992TheEO; @bellCostsReproductionTheir1980]. @stearns92 define a life-history trait as phenotypic characteristics that will directly impact an individual's selective value, or "fitness" (i.e., individual's capacity to transmit their genes to the next generation, measured as the product of survival and reproductive success). However, this is a wide definition that could correspond to almost any traits as most phenotypic trait could impact either survival or reproductive success. For example, body condition and time of nesting both predicts the probability of survival of nesting females in tufted ducks (*Aythya fuligula*), common pochard (*Aythya ferina*), and northern shoveler (*Anas clypeata*) [@blumsIndividualQualitySurvival2005]; bold and active trinidanian guppies (*Poecilia reticulata*) survive longer against predators [@smithBehavioralTypesPredictors2010]; number of mate and general reproductive success is impacted by crest and gluteal size in males western gorillas [*Gorilla gorilla*, @breuerPhenotypicCorrelatesMale2012]; high agressivity, related to testosterone correlate with a greater reproductive success in females dark-eyed junco [*Junco hyemalis*, @cainCompetitiveFemalesAre2012]. But conversely, one could argue that no trait would impact directly, *per se*, an individual fitness. For example, horn size in bighorn sheep, *Ovis canadensis*, is correlated with lifetime reproductive success [@deakinEweAreWhat2022], but is it direct predictor or does it only impact fighting ability, which would improve individual mating success?
...
<!--JM comps: capital vs income breeder-->
...
Hence, evolution can be slow but will have effect on long-term, and might be a better answer to persistent ecological changes. However, if the change is transient, plasticity might be better suited. As noted by @dewittCostsLimitsPhenotypic1998 and @gardnerDecliningBodySize2011, phenotypic plasticity solely is unlikely to be the most optimal long-term response to climate change as it is usually a transient answer to a temporary change,presenting costs and limits. As proposed by, @dewittCostsLimitsPhenotypic1998, plasticity present different costs:

* [Energetic costs]{.underline}, to be able to acquire environmental cues, product and maintain phenotypic modification in response,
* [Genetic cost]{.underline}, coming from genetic linkage potentially maintaining deleterious genes,
* [Developmental instability]{.underline}, too many phenotypic modification, caused by a variable environment, will deleterious under stabilizing selection context.<!-- JM missing some words in this sentence ??? I don't understand it -->
...
As our study site has been an important scientific station for more than a century, we have various and exhaustive data. By combining multiple sources of data, such as billy barr <!-- JM note billy is against uppercase for his name--> (an amateur scientist, hermit and only year long RMBL  <!-- JM you can add a reference or two about him, have a look at wikipedia references about him if needed or use https://www.nationalgeographic.com/science/article/billy-barr-weather-data-climate-science -->), the National Oceanic and Atmospheric Administration (NOAA), the United States Geological Survey (USGS), the United States Department of Agriculture (USDA) and the Oregon State University's PRISM Climate group, @pratherClimateDataRocky2023 provides us with exhaustive data. We have weather data (e.g., monthly temperatures, snowing, precipitations, season lengths) at our study site from 1975 to 2022.
...
Illustration of framework for chapter 2 focusing on evolution of body mass across sex, age and time of the year in yellow-bellied marmots.
<!-- JM a bit short for a legend, you need to provide more info. Do the same for all your chapters also those plots should appear at the start of the chapters not later on -->

:::

For my first chapter I will study how body mass has changed in this population over the study period across sexes, age classes and time of year (@fig-framework-chapter-1). We know that body mass at the end of the active season (estimated on August 15^th^) has increased for adult females at both phenotypic and genetic level (Birot, Blumstein & Martin, Manuscript in progress). However, we still don't know how the body mass of adult females at the beginning of the active season (estimated on June 1^st^) varied over the same time period, nor for the other age classes, nor for the males. It is crucial to consider that selective pressure, genetic structure and evolution could be different over different sex and age classes. We need to consider the "missing fraction" [i.e., bias occurring from a specific kind of viability selection resulting in an adult population including only a certain subset of phenotypes, @mittell2024missing] in order to conduct a comprehensive study of the selection acting on marmots body mass [@grafen1988uses; @hadfieldEstimatingEvolutionaryParameters2008a; @jebbBiggerNotAlways2021].
...
Finally, it is worth noting a potential bias with this method that must be taken into account when performing such analysis. When individuals are sampled on different range of environmental values then the within-indivdiual variance in residual variance could be different from zero despite an absence of *I \* E* (@fig-unbalanced). However, adding the environment as a fixed effect in the model would remove this bias.

::: {#fig-unbalanced}

![](figures/unbalanced.png)

Reactions norms for two individuals (blue and yellow) for a trait a) without I * E (i.e., same slope between individuals) but in an unbalanced design, b) showing different range of expressed phenotype.
<!-- JM why not combine the figures from that chapters together. I think it would be better -->
:::
...
Potential predictors of increased body mass in Yellow-Beliied Marmot.
...
A meta-population is defined as a set of subpopulations distributed across various patches, more or less interconnected. Links between subpopulations (i.e., migration fluxes) in a meta-populations is crucial for its survival over time, as it maintains genetic diversity <!--REF-->. If a subpopulation finds itself isolated from the rest of the network, lack of genetic diversity putting it at risk of extinction <!--REF-->.
...
<!--JM this is more than enough for a side project-->
