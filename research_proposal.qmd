...
- Individuals with greater energy reserves have a better capacity to reproduce, as illustrated in bighorn sheeps, *Ovis canadensis* [@festa-bianchetMassDensityDependentReproductive1998]
...
Body captures height (important for fitness in some species for access to reproduction) but also energetic reserve (impact on survival) => Mass is therefore important to study -->
...
"Although some could argue that body mass can be considered as a Life History Traits in some species as it can impact directly the fitness of an individual, due to the lack of a clear definition, I will just say that Body mass can be seen as a NODE impacting other traits, finally impacting global fitness. In this optic, it is crucial to study and understand body mass evolution."
...
Finally, I will test the effect of the interaction between body mass and individual age while accounting for time cohort variation and controlling for individual and measurement year effects, using linnear mixed models (@eq-mod-ch4-m3).
...
Add the definition in text (Stearns) & use lande & arnold in oral presentation -->
