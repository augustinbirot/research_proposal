...
First thing to do would be to study these patterns at the beginning and end of the active season for each age classes at both the phenotypic and genetic level to describe the changes in the last half century. Then, will be intersting to investigate both the average cohorts mass at these two moments, and the reaction norm and slope of each cohort during the active season.
