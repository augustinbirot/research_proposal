...
First, I need <!-- JM comps WHY do you need to do it -->to provide a clear explanation of what has precisely changed in the body mass in this population. We already have studied the body mass at the end of the active season for the adult female. However, to properly study it, we need to understand the structure of the phenotypic change. Hence, I will study the body mass at both the beginning and the end of the active season, for each age class, at both phenotypic and genetic levels.
...
Then, I want to understand the causes of this increase in body mass. After having study the body mass at the beginning and end of the active season, I will be able to test the effect of active, hibernation seasons and season length on body mass increase (during active season) and loss (during hibernation).
...
<!-- JM what is the colour coding. Is it associated to functional questions, data structure, chapters? please provide more details in the legend and if it could be colour coded by chapter it would be amazing -->
...
# Chapter 1. Body mass increase over time, sex, age class and season {#sec-chap1}

<!-- JM overall great ideas in this chapter but poorly justified and presented. You keep saying "we need" but in science we never need to do anything until we have clearly explained why.

also other aspect you can mention here would be to do a eigen decomposition of the G matrix to check for antagonistic pleitropy might be 2 papers need to see how we do it given the draft I alreday have on the topic -->

The first thing needed,<!-- JM: needed for what? just say for my first chapter I will ... --> is to analyze deeply <!-- JM what do you mean by deeply -->[the structure of change]<!-- JM what do you mean by that -->in body mass in our population. We know that body mass at the end of the active season (estimated on August 15^th^) has increased for adult females at both phenotypic and genetic level (Birot, Blumstein & Martin, Manuscript in progress). However, we still don't know how the body mass of adult females at the beginning of the active season (estimated on June 1^st^) varied over the same time period, or for the other age classes. It is crucial to consider that selective pressure, genetic structure and evolution could be different over different sex and age classes. We need to consider the "missing fraction" in order to conduct a comprehensive study of the selection acting on marmots body mass [@grafen1988uses; @mittell2024missing; @hadfieldEstimatingEvolutionaryParameters2008a; @jebbBiggerNotAlways2021]. <!-- JM define missing fraction -->
Hence, by structure, I refer to the patterns and component of this change (i.e., over age classes and at different times of the active season) at both phenotypic and genetic level.<!-- JM I don't get this sentence. I think you can remove it and don<t use structure-->
...
The first step is going to be to gather environmental data. I will be able to extract and estimate hibernation and active season length, seasonal conditions (average snowpacks, average temperatures and precipitation), food availability, and drought frequency and severity over the last 50 years (@fig-plan-chapter3).<!-- JM: comps note: be ready to explain what and how you get those data. remote sensing, explain them and what are the potential limitations of those type of data -->

:::{#fig-plan-chapter3}

![](figures/fig_plan_chapter_3.png)
...
<!-- JM PCA on repeat measures are you sure ??? -->
