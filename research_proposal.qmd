...
Data are stored in the R package "ybamaRmot" [@ybamaRmot], analysis will be performed in R [@base], Animal models will be performed using R package asreml [@butler2017asreml], lme4breeding [@covarrubias2024lme4breeding] and MCMCglmm [@mcmcglmm], DHGLMs and other complex models using a bayesian approach will be done with brms [@brms] or stan directly [@carpenterStanProbabilisticProgramming2017; @rstan], figures will be made with "ggplot2" [@ggplot].
...
On the other hand, an increased body mass, being synonym of a more important energy stock, potentially allow indivduals to increase survival in a harsh year. This can be very important for species living in highly challenging environment, such as high altitude [@inouyeHighAltitudeClimates2003]. Therefore, increase in body mass to "buffer" years with less ressources can be expected, especially for hibernating species in alpine environment.
...
1. Beyond plasticity: Evidence for strong evolutionary signal behind the observed body mass increase in Yellow-bellied Marmot. [A Birot, D Blumstein and JGA Martin]{.underline} *Prepared for Evolution*


**Thesis**

2. Towards more comprehensive studies of phenotypic changes: the case Yellow-bellied Marmots' body mass. [Augustin Birot, 
...
4. Which part of climate change drives body mass evolution? [Augustin Birot, Dan Blumstein and 
