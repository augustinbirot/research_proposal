...
Climate change has numerous impacts on human society which are, for example, well represented in the city of Ottawa,Canada. Temperature, snow and rainfall in the Canadian capital over the last century reflect worrying but expected trends [*e.g.*, increasing temperature, less snow, more rain, @walshPrecipitationTemperatureTrends2022], and future projections are not reassuring [*e.g.*, further increases in temperature, @zhaiFutureProjectionsTemperature2019]. Illustrating this trend is the management of the Rideau canal ice skating rink. Indeed, in past few years, the opening of the world's longest ice staking risk has been more and more uncertain, and its future is unfortunately but, fatally, questionable.

Above all, as shown by countless studies, climate change deeply impacts the vast majority of Earth's ecosystems [@intergovernmentalpanelonclimatechangeipccClimateChange20222022]. Of these, Alpine habitats are especially susceptible to climate change, with more pronounced and severe droughts, as well as increased temperature and variability. Hence, climate change puts high elevation environments at greater risk and may cause changes in plant communities [@inouyeHighAltitudeClimates2003; @ohmuraEnhancedTemperatureVariability2012; @inbook; @giorgiElevationDependencySurface1997; @grabherrClimateChangeImpacts2010], with major impacts on food availability for a wide diversity of animals. Therefore, Alpine animals must adjust not only to changes in temperature and precipitations, but also potentially to food availability.
...
* [migration]{.underline}, which maintains gene flow between subpopulations, both inssuring genetic homogenization and bringing new variation in the population;
...
* and [natural selection]{.underline}.

For this natural selection to drive evolutionary change, three conditions must be met: 1. there must be phenotypic variation among individuals; 2. this variation must be associated with differences in fitness; and 3. these differences must be transmissible to the next generations (i.e., heritability) [@lewontinUnitsSelection1970]. When these conditions are satisfied, individuals with advantageous phenotypes will have a higher reproductive succes, thus transmitting their genes across generation, eventually increasing in frequence in the population [@lynchGeneticsAnalysisQuantitative1998].
...
* [Developmental instability]{.underline}, too many phenotypic modification, caused by a variable environment, will delleterious under stabilizing selection context.

@dewittCostsLimitsPhenotypic1998, also proposed some limits to plasticity:

* [Information reliability limit]{.underline}, a plastic reponse isn't necessarily the right answer to given environment (i.e., wrong cue or variable environment),
* [Lag-time]{.underline}, corresponding to the time between the enviromnental change and the phenotypic response,
...
On the other hand, evolution rely on genetic change, therefore evolution can be studied by looking at changes in the genetic values of indvidiuals born in different cohorts.
...
Research objectives illustrative framework, colour-coded by chapters research objectives.
...
For my first chapter I will study how body has changed in this population over the study period over sexes, age classes and time of year (@fig-framework-chapter-1). We know that body mass at the end of the active season (estimated on August 15^th^) has increased for adult females at both phenotypic and genetic level (Birot, Blumstein & Martin, Manuscript in progress). However, we still don't know how the body mass of adult females at the beginning of the active season (estimated on June 1^st^) varied over the same time period, nor for the other age classes, nor for the males. It is crucial to consider that selective pressure, genetic structure and evolution could be different over different sex and age classes. We need to consider the "missing fraction" [i.e., bias occuring from a specific kind of viabilirty selection resulting in an adult population including only a certain subset of phenotypes, @mittell2024missing] in order to conduct a comprehensive study of the selection acting on marmots body mass [@grafen1988uses; @hadfieldEstimatingEvolutionaryParameters2008a; @jebbBiggerNotAlways2021].
...
We have repeated observations for a lot of individuals over various variables from observations from 2-min focal observations and flight-initiation distance experiments. I am going to reassess the repetability (using mixed models) of each of these variables, then look at the correlation between those variables to determine individual values for various personality traits such as boldness [@realeIntegratingAnimalTemperament2007a]. Then I will determine the heritability of each of these traits (using animal models, @eq-mod-ch4-m1).
