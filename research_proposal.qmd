...
Body mass also determines individuals energetic reserves, therby impacting performance<!-- REF --> and resilience to environmental challenges by buffering against seasonal food scarcity [@heldstabHowMammalsBuffer2017]. More generaly, body fat can be considered a buffer against harsh environments [@denryterSurvivalFattestHow2022]. Extending this reasoning to a wider timescale, we can expect that larger individuals may better buffer rseource-poor years, increasing their resilience to environmental variability and unpredictability [@einum2004environmental].
