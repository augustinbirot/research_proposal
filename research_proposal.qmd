...
Additionally, individuals with greater energy reserves have a better capacity to reproduce [@festa-bianchetMassDensityDependentReproductive1998]. {Body mass would also be an "honest signal" of an individual capacity to accumulate resources and its quality as a reproducer (**REF**)} <!-- TODO: Change that -->. Overall, a bigger body mass would lead to a better reproductive success.
<!-- TODO: add examples, "why body mass impact reproduction or survival" -->
...
<!-- TODO: add details about mass biology and physiology, link that with the role of body mass -->
...
When an environment changes, inhabiting populations can avoid disappearance in several ways. They can disperse to another, more favourable, environment [@gienappEvolutionaryDynamicsResponse2014]; they can modify their environment to correspond to specific needs (**REF**); or phenotypic changes can occur in the population, giving individuals better suited to their environment [@gienappEvolutionaryDynamicsResponse2014].
