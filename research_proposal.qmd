...
Body mass plays a critical role for most species. It affects individual metabolic rate [@darveauAllometricCascadeUnifying2002]. For instance, @weibelAllometricScalingMaximal2004 showed a strong correlation between maximal metabolic rate and body mass in mammals.
...
Although detecting that $V_{V_e}$ is different from 0 isn't a proof of *I \* E* in itself, as the variation could be due to other processes, it is a necessary condition of *I \* E* <!-- JM: (except under very unlikely conditions @fig-opposed_unbalanced a & b) JM honestly it works only if you have 2 individuals or only 2 potential slopes so i don<t think it is even necessary to mention-->. Finding $V_{V_e} > 0$ would thus suggest that investigating I * E and looking for the unknown E is a worthwhile investigation. 
